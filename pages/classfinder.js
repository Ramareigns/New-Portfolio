    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-4 grid md:grid-cols-4 gap-8 pt-8">
        <div className="col-span-4 font-bold">
          ...
          <a href="https://ramareigns.github.io/Website-Bitcam22/"><button className="px-8 py-2 mt-4 mr-8 text-white">Demo</button></a>
          <a href="https://github.com/Ramareigns/Website-Bitcam22"><button className="px-8 py-2 mt-4 text-white">Code</button></a>
        </div>
        <div className="col-span-4 mid:col-span-1 shadow-xl shadow-black rounded-xl p-4 ">
          <div className="p-2">
